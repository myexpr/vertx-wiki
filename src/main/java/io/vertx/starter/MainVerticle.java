...
public class MainVerticle extends AbstractVerticle {
  ...
  public void start(Future<Void> startFuture) throws Exception {
    Future<Void> composed = prepareDatabase().compose(v -> startHttpServer());
    composed.setHandler(startFuture.completer());
  }
  ...
  private Future<Void> prepareDatabase() {
    ...
    dbClient.getConnection(ar -> {
      if (ar.failed()) {
        ...
        connection.execute(SQL_CREATE_PAGES_TABLE, createResult -> {
          connection.close();
